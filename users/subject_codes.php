        ...
        <aside class="app-sidebar">
            <div class="sidebar-section">
                ...
                <div class="sidebar-menu">
                    ...
                    <a class="sidebar-link <?php echo $activePage === 'subject_codes' ? 'active' : ''; ?>" href="subject_codes.php">My Subject Codes</a>
        ...
        <main class="app-main">
            <div class="content-header">
                <div>
                    ...
                    <h1 class="page-title">My Subject Codes</h1>
                </div>
            ...
            <div class="card card-hover">
                <div class="table-responsive">
                    <table class="table align-middle" id="codeTable">
                        <thead>
                            <tr><th>ID</th><th>Subject</th><th>Code</th><th class="text-end">Actions</th></tr>
                        </thead>
                        <tbody>
