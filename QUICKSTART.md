...
1. **Prerequisites**
   - XAMPP with Apache, PHP 8.2 or higher, and MySQL running.
   - A browser and phpMyAdmin access.

2. **Place the project**
   - Copy this repository into your XAMPP `htdocs` directory and name the folder `aqpg` (or update the URLs in step 5 to match your folder name).
